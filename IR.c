...
void display_message()
{
        ...
        {
            Disp2String("\r\nChannel mode: Channel up received"); // Display "Channel mode: Channel up received"
        }
        else if (message == 0xE0E008F7)
        {
            Disp2String("\r\nChannel mode: Channel down received"); // Display "Channel mode: Channel down received"
        }
        else if (message == 0xE0E0E01F)
        {
            Disp2String("\r\nVolume mode: Volume up received"); // Display "Volume mode: Volume up received"
        }
        else if (message == 0xE0E0D02F)
        {
            Disp2String("\r\nVolume mode: Volume down received"); // Display "Volume mode: Volume up received"
        }
